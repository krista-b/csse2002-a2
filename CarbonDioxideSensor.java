...
public class CarbonDioxideSensor extends TimedSensor implements HazardSensor
    ...
    public int getComfortLevel() {
        final int currentReading = this.getCurrentReading();
        int difference = Math.abs(this.getIdealValue() - currentReading);
        if (difference >= this.getVariationLimit()) {
            return 0;
        } else {
            double ratio = ((double) difference) / this.getVariationLimit();
            double ratioPct = 100 * ratio;
            return (int) Math.round(100 - ratioPct);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return super.equals(obj) && this.idealValue == sensor.getIdealValue()
                && this.variationLimit == sensor.getVariationLimit();
    }
    ...
    @Override
    public int hashCode() {
        return super.hashCode() * this.variationLimit * this.idealValue;
    }
